        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-capitalize fw-bolder m-0 py-3 fs-5">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('instruction.index') }}" class="text-decoration-none">Hướng dẫn</a>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="bg-white p-3">
                        ...
                        <div>
                            <img class="mb-3" src="{{ getImageUrl($instruction->image) }}" alt="{{ $instruction->slug }}"
                                style="width: 100%;">
                    ...
                    <div id="latest-news" class="mt-2">
                        <div style="border-bottom: 2px solid #002ab0;">
                            <h6 class="d-inline text-white pb-1 px-2 pt-1 text-uppercase"
                                style="background-color: #002ab0;">HƯỚNG DẪN MỚI NHẤT</h6>
                        </div>
                        <div>
