    ...
    <div id="event-section" class="container mt-3">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-capitalize fw-bolder m-0 py-3 fs-5">
                ...
                <li class="breadcrumb-item"><a href="#" class="no-active">Hướng dẫn</a></li>
            </ol>
        </nav>
        <div class="mt-3">
            <div style="border-bottom: 2px solid #002ab0; ">
                <h6 class="d-inline text-white pb-1 px-2 pt-1" style="background-color: #002ab0;">HƯỚNG DẪN</h6>
            </div>
            <div class="mt-3">
                <div class="row">
                    @foreach ($instructions as $instruction)
                        <div class="col-sm-4 mb-3">
                            <div class="card border-0 rounded-4 bg-transparent h-100">
                                <img src="{{ getImageUrl($instruction->image) }}"
